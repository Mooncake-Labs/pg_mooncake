...
**pg_mooncake** is a PostgreSQL extension that adds native columnstore tables with DuckDB execution for 1000x faster analytics. 

Columnstore tables are stored as [Iceberg](https://github.com/apache/iceberg) or [Delta Lake](https://github.com/delta-io/delta) tables in object storage.
